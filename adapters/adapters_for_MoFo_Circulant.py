...
class TransformerAdapterCirculant(ModelBase):
    def __init__(self, model_name, model_class, **kwargs):
        super(TransformerAdapterCirculant, self).__init__()
...
def generate_model_factory(
    ...
    def model_factory(**kwargs) -> TransformerAdapterCirculant:
        return TransformerAdapterCirculant(model_name, model_class, **kwargs)
...
def transformer_adapter_circulant(model_info: Type[object]) -> object:
