...
class TransformerAdapterCircBias(ModelBase):
    def __init__(self, model_name, model_class, **kwargs):
        super(TransformerAdapterCircBias, self).__init__()
        self.config = TSLibConfigCB(**kwargs)
...
def generate_model_factory(
    ...
    def model_factory(**kwargs) -> TransformerAdapterCircBias:
        return TransformerAdapterCircBias(model_name, model_class, **kwargs)
...
def transformer_adapter_circbias(model_info: Type[object]) -> object:
